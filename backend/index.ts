...
//       path.join(
//         __dirname,
//         "../../../../../etc/letsencrypt/live/saritestsecond.online/privkey.pem"
//       )
//     ),
//     cert: fs.readFileSync(
//       path.join(
//         __dirname,
//         "../../../../../etc/letsencrypt/live/saritestsecond.online/fullchain.pem"
//       )
//     ),
//   },
//   app
...
// const server = http.createServer(app);
export const io = initSocket(server); // Initialize Socket.io and pass the serverver instance

// Start the HTTP serverver
server.listen(PORT, () => {
